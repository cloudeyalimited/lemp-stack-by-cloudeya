...
This open source solution is packaged by Phooni. Learn how to install, configure, and manage it. For deployment issues, reach out our support team [here](https://www.phooni.com/contact/).

Why use Phooni Certified Apps?

Phooni certified images are always up-to-date, secure, and built to work right out of the box.
...
LEMP Stack by Phooni is pre-configured with the following technologies:
